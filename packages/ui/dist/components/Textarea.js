...
const Textarea = React.forwardRef(({ className, label, error, helperText, id, ...props }, ref) => {
    ...
    return ((0, jsx_runtime_1.jsxs)("div", { className: "w-full", children: [label && ((0, jsx_runtime_1.jsx)("label", { htmlFor: textareaId, className: "mb-1.5 block text-body-sm font-medium text-ink", children: label })), (0, jsx_runtime_1.jsx)("textarea", { id: textareaId, className: (0, utils_1.cn)('flex min-h-[100px] w-full rounded-lg border bg-canvas p-4 text-body-md placeholder:text-mute transition-all duration-fast resize-none', 'focus:outline-none focus:ring-2 focus:ring-focus-ring focus:ring-offset-2 focus:border-transparent', 'disabled:cursor-not-allowed disabled:opacity-50', error && 'border-error focus:ring-error', className), ref: ref, "aria-invalid": error ? 'true' : 'false', "aria-describedby": describedBy, ...props }), error && ((0, jsx_runtime_1.jsx)("p", { id: errorId, className: "mt-1.5 text-caption-sm text-error", role: "alert", children: error })), helperText && !error && ((0, jsx_runtime_1.jsx)("p", { id: helperId, className: "mt-1.5 text-caption-sm text-mute", children: helperText }))] }));
});
