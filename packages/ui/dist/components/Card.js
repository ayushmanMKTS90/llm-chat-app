...
const Card = React.forwardRef(({ className, ...props }, ref) => ((0, jsx_runtime_1.jsx)("div", { ref: ref, className: (0, utils_1.cn)('rounded-lg bg-surface-card text-ink border border-hairline', className), ...props })));
exports.Card = Card;
...
const CardTitle = React.forwardRef(({ className, ...props }, ref) => ((0, jsx_runtime_1.jsx)("h3", { ref: ref, className: (0, utils_1.cn)('text-heading-md font-display font-semibold leading-none tracking-tight', className), ...props })));
exports.CardTitle = CardTitle;
CardTitle.displayName = 'CardTitle';
const CardDescription = React.forwardRef(({ className, ...props }, ref) => ((0, jsx_runtime_1.jsx)("p", { ref: ref, className: (0, utils_1.cn)('text-body-sm text-mute', className), ...props })));
